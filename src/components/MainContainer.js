        ...
        <div className="leftcontent">
          <div className='leftcontent_content'>
            <div className='leftcontent_header'>
              <h1>{newData.articles[0].head}</h1>
              <p>{newData.articles[0].teaser}</p>
            </div>
            <p className='leftcontent_author'>{newData.articles[0].text}</p>
          </div>
          <img className='header_image' src="https://www.shutterstock.com/image-photo/studio-portrait-career-lady-female-260nw-2162083655.jpg" />
        </div>
        <div className='bottom_content'>
          <div className='bottom_content_first'>
            <img src="https://www.shutterstock.com/image-photo/studio-portrait-career-lady-female-260nw-2162083655.jpg" />
            <Article data={newData.articles[2]} />
          </div>
          <div className='bottom_content_double'>
            <Article data={newData.articles[3]} />
            <div className='bottom_content_middle'>
              <Article data={newData.articles[4]} />
            </div>
          </div>
          <div className='bottom_content_first'>
            <img src="https://www.shutterstock.com/image-photo/studio-portrait-career-lady-female-260nw-2162083655.jpg" />
            <Article data={newData.articles[5]} />
          </div>
        </div>
      </div>
      {/* RightContent */}
